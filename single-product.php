...
<body>
	...
	<!-- single product -->
	<div class="single-product mt-250 mb-150">
		<div class="container">
			<div class="row">
				<div class="col-md-5">
				...
				<div class="col-md-7">
					<div class="single-product-content">
						<h3>Bin Zhaiman coffee</h3>
						<p class="single-product-pricing"><span>
						</span> $20</p>
						<p>Delicious Palestinian Turkish coffee without additives</p>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<h3>pickled grape leaves
						</h3>
						<p class="product-price"><span>Per Kg</span> 19.9$ </p>
						<a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<p class="product-price"><span>Per Kg</span> 23$ </p>
						<a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3 text-center">
					<div class="single-product-item">
						...
						<p class="product-price"><span>Per piece
						</span> 35$ </p>
						<a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
