...
if (isset($_POST['addProduct'])){  
    ...
    $description=$_POST['description'];
    $Expire_Date=$_POST['Expire_Date'];
    add("products","img,name,category_id,price,description,Expire_Date" ," '$$imgNewNameDB','$name','$category','$price','$description','$Expire_Date' ","addproduct.php");
